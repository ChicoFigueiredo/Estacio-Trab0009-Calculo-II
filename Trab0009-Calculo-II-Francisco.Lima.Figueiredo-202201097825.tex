...
\titulo{
	Resenha do artigo "O USO DA INTEGRAL DEFINIDA NO CÁLCULO DA ÁREA ALAGADA DA BARRAGEM DO RIO BONITO"
}%
...
\preambulo{
	Trabalho apresentado à professora Ana Lucia de Sousa como requisito parcial para obtenção da aprovação na disciplina 
    Cálculo II (CEL0498) 9001.
}
...
\chapter{Introdução}
	\section{Objetivos}
		Efetuar uma reflexão a partir da leitura do artigo \citeaa{Paraol2015} referente ao aplicações do cálculo II no dia a dia. 
		
		
	\section{Leitura} 
		\citeaa{Paraol2015} apresentam em seu artigo intitulado \textit{"O uso da integral definida no cálculo da área alagada da barragem do Rio Bonito"} uma interessante aplicação de integral aprendida no curso de cálculo II.
...
\chapter{Desenvolvimento}
	...
	O descritivo de cada curva ajustada mostrada nos resultados permite a qualquer pesquisador confrontar ou refutar o trabalho realizado. Uma conclusão a partir dos dados que, dado que a área de $803.514,7392m^{2}$ leva a supor que se a barragem possuir 5m de profundidade média, estamos falando de um volume de 4.017,6 toneladas de água.
