...
\chapter{Desenvolvimento}
	...
	\begin{enumerate}
		...
		papel das variáveis x e t na definição da função $\displaystyle F: [a, b] \rightarrow \mathds{R} $ , com $ F(x) = \int\limits_a^x { f(t) dt} $, e 	possíveis conseqüências na relação recíproca entre a derivada e a integral, cerne do Teorema Fundamental do Cálculo.
