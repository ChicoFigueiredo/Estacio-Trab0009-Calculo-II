...
\chapter{Introdução}
	\section{Objetivos}
		Efetuar uma reflexão a partir da leitura dos textos de \citeaa{Silva2011} e \citeaa{Goncalves2013} referente ao tema do ensino e aprendizagem da análise combinatória, como elemento de compreensão e evolução da álgebra ensinada no ensino fundamental e médio.
